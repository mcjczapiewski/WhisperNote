...
- 2026-07-15: remaining Settings-tab publication root cause fixed by deriving the directory label instead of mutating `@State` in `SettingsView.init`. Focused release-invariant run: 11 passed. Version 1.4.11 is ready to commit and push on `phase2`.
